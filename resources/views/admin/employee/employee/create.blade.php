                    ...
                    <form action="{{ route('admin.employee.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if (config('default.dual_language'))
                            <div class="input-style-1">
                                ...
                                <input type="text" id="level_en" name="level_en"
                                    class="@error('level_en') is-invalid @enderror" value="{{ old('level_en') }}">
                                @error('level_en')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        @if (config('default.dual_language'))
                            <div class="input-style-1">
                                ...
                                <input type="text" id="address_en" name="address_en"
                                    class="@error('address_en') is-invalid @enderror" value="{{ old('address_en') }}">
                                @error('address_en')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <textarea type="text" id="acedamic_qualification" name="acedamic_qualification"
                                class="@error('acedamic_qualification') is-invalid @enderror" placeholder="Acedamic Qualification"
                                value="{{ old('acedamic_qualification') }}"></textarea>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="current_office" name="current_office"
                                ...
                                placeholder="Current Office Address" value="{{ old('current_office') }}" />
                        ...
                        <div class="col-md-12">
                            <div class="input-style-1">
                                ...
                                <textarea name="expertise" id="expertise" cols="30" rows="10" class="ckEditor"></textarea>
                                @error('expertise')
                        ...
                        <div class="col-md-12">
                            <div class="input-style-1">
                                ...
                                <textarea name="experience_n_research" id="experience_n_research" cols="30" rows="10" class="ckEditor"></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" id="fb_url" name="fb_url"
                                        class="@error('fb_url') is-invalid @enderror"
                                        value="{{ old('fb_url') }}">
                                    @error('fb_url')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="col-md-4">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" id="insta_url" name="insta_url"
                                        class="@error('insta_url') is-invalid @enderror"
                                        value="{{ old('insta_url') }}">
                                    @error('insta_url')
                                        <div class="invalid-feedback">
                                            {{ $message }}

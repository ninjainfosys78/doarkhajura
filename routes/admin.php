...
ImageController,
    ...
    ResearchUnitController,
    SampleCollectionController,
    SliderController,
    SmugglingController,
    SpermDistributionController,
...
Route::resource('farmerHelpfull',FarmerHelpfullController::class);
Route::resource('researchUnit',ResearchUnitController::class);
Route::get('subResearchUnit', [ResearchUnitController::class, 'subResearchUnit'])->name('subResearchUnit');
Route::resource('agronomy',AgronomyController::class);
...
Route::resource('sampleCollection', SampleCollectionController::class);
Route::put('sampleCollection/{sampleCollection}/showOnIndex', [SampleCollectionController::class, 'showOnIndex'])->name('sampleCollection.showOnIndex');
Route::get('sampleCollection/{sampleCollection}/showOnIndex', [SampleCollectionController::class, 'showOnIndex'])->name('sampleCollection.showOnIndex');

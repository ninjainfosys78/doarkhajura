            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="ckEditor">{{$officeDetail->description}}</textarea>
                        @error('description')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                @if(config('default.dual_language'))
                    <div class="col-md-12">
                        <div class="input-style-1">
                            ...
                            <textarea name="description_en" id="description_en" cols="30" rows="10" class="ckEditor">{{$officeDetail->description_en}}</textarea>

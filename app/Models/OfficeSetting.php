...
class OfficeSetting extends Model
{
    ...
    public function siemensOfficer(): BelongsTo
    {
        return $this->belongsTo(Employee::class, 'siemens_officer_id');
    }

    public function distributionOfficer(): BelongsTo
    {
        return $this->belongsTo(Employee::class, 'distribution_officer_id');
    }


    public function officeSettingHeaders(): HasMany
    {

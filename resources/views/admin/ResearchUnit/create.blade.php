...
@section('content')
    ...
    <div class="card-style mb-30">
        ...
        <form action="{{ route('admin.researchUnit.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf
            <div class="row">
                <div class="col-md-6">
                        ...
                        <div class="select-position">
                            ...
                            <select id="research_unit_id" name="research_unit_id"
                                ...
                                <option value="">-- Select Department --</option>
                                        ...
                                        <option {{$mainResearchUnit->id===old('research_unit_id') ? 'selected' : ''}}
                                                value="{{$mainResearchUnit->id}}">
                ...
                @if (config('default.dual_language'))
                    <div class="col-md-6">
                        <div class="input-style-1">
                            ...
                            <input type="text" id="research_unit_name" name="research_unit_name" placeholder="शीर्षक English"
                                value="{{ old('research_unit_name') }}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        <label for="research_unit_name_en">अनुसन्धान इकाई नाम</label>
                        <input type="text" id="research_unit_name_en" name="research_unit_name_en" placeholder="शीर्षक English"
                            value="{{ old('research_unit_name_en') }}">

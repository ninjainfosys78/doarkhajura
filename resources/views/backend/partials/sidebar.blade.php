<aside class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            {{-- <li class="nav-item {{ request()->is('admin/researchUnit*') ? 'active' : '' }}">
                <a href="{{ route('admin.researchUnit.index') }}">
                    <span class="icon">
                        <i class="mdi mdi-abacus"></i>
                    </span>
            ...
            <li class="nav-item">
                <a href="{{ route('admin.researchUnit.index') }}">
                    ...
                    <span class="text">अनुसन्धान इकाईहरु
                    </span>
                </a>
            </li>
            ...
            <li class="nav-item {{ request()->is('admin/farmerHelpfull*') ? 'active' : '' }}">
                <a href="{{ route('admin.farmerHelpfull.index') }}">
                    <span class="icon">
                        <i class="mdi mdi-abacus"></i>
                    </span>
                    <span class="text">किसान उपयोगी सामाग्री
                    </span>
                </a>
            </li>
            <li class="nav-item {{ request()->is('admin/agronomy*') ? 'active' : '' }}">
                <a href="{{ route('admin.agronomy.index') }}">
                    <span class="icon">
                        <i class="mdi mdi-abacus"></i>
                    </span>
                    <span class="text">Agronomy
                    </span>
                </a>
            </li>
            ...
            <li class="nav-item {{ request()->is('admin/sampleCollection*') ? 'active' : '' }}">
                <a href="{{ route('admin.sampleCollection.index') }}">
                    <span class="icon">
                        <i class="mdi mdi-link"></i>
                    </span>
                    <span class="text">नमुना संकलनहरु</span>
                </a>
            </li>

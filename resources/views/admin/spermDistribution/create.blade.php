        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-style mb-30">
                    ...
                    <form action="{{route('admin.spermDistribution.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="input-style-1">
                            <label for="name">नाम</label>
                            <input type="text" id="name" name="name" class="@error('name') is-invalid @enderror"
                                   placeholder="नाम" value="{{old('name')}}">
                            @error('name')
                            ...
                            <div class="select-position">
                                ...
                                <select id="pedigree_caste_id" name="pedigree_caste_id"
                                    ...
                                    @foreach($pedigreeCastes as $caste)
                                        <option
                                            value="{{$caste->id}}" {{old('pedigree_caste_id')==$caste->id ? 'selected':''}}>{{$caste->title}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="tag" name="tag" class="@error('tag') is-invalid @enderror"
                                   placeholder="पहिचान चिन्ह" value="{{old('tag')}}">
                            @error('tag')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="address" name="address" class="@error('address') is-invalid @enderror"
                                   placeholder="क्षेत्र वा प्रदेश" value="{{old('address')}}">
                            @error('address')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" placeholder="अबधि" value="{{old('duration')}}" name="duration" class="form-control" id="duration">
                            @error('duration')
                            {{$message}}
                            @enderror
                        </div>

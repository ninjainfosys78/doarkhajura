        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-style mb-30">
                    ...
                    <form action="{{route('admin.agronomy.store')}}" method="POST"
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="quotes" name="quotes" class="@error('quotes') is-invalid @enderror"
                                   placeholder="quotes" value="{{old('quotes')}}">
                            @error('quotes')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="text" id="quotes_en" name="quotes_en" class="@error('quotes_en') is-invalid @enderror"
                                   placeholder="quotes_en" value="{{old('quotes_en')}}">
                            @error('quotes_en')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="input-style-1">
                            ...
                            <input type="file" id="url" name="photo" class="@error('photo') is-invalid @enderror">
                            @error('photo')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                                ...
                                <div class="select-position">
                                    ...
                                    <select id="scientist_id" name="scientist_id"
                                        ...
                                        <option value="">-- Select Department --</option>
                                                ...
                                                <option {{$employee->id===old('scientist_id') ? 'selected' : ''}}
                                                        value="{{$employee->id}}">
                                                    {{$employee->name}}
                                                </option>
                                            @endforeach
                            ...
                            <div class="select-style-1">
                                <div class="select-position">
                                    ...
                                    <select id="technical_officer_id" name="technical_officer_id"
                                        ...
                                        <option value="">-- Select Department --</option>
                                                @foreach($employees as $employee)
                                                <option {{$employee->id===old('technical_officer_id') ? 'selected' : ''}}
                                                        value="{{$employee->id}}">
                                                    {{$employee->name}}
                                                </option>
                                            @endforeach

...
class DocumentController extends BaseController
{
    ...
    public function create(DocumentCategory $documentCategory)
    {
        ...
        return view('admin.documents.document.create', compact('documentCategory','researchUnits'));
    }
    ...
    public function edit(DocumentCategory $documentCategory, Document $document)
    {
        ...
        return view('admin.documents.document.edit', compact('documentCategory','document','researchUnits'));
    }
